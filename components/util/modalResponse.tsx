...
export const ModalResponse = (props: any) => {
                    ...
                    <div className="relative p-4 w-full max-w-md max-h-full mx-auto">
                        <div className="relative bg-white rounded-lg shadow">
                            ...
                            <div className="p-4 md:p-5 text-center">
                                ...
                                <button onClick={props.hideModal} data-modal-hide="popup-modal" type="button" className="text-white bg-violet-600 hover:bg-violet-800 focus:ring-4 focus:outline-none focus:ring-violet-300 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center me-2">
                                    Aceptar
                                </button>
